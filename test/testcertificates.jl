certificates = getallcertificates!(client)
...
certificate = getcertificate!(client, "892071a0-bb95-49bc-8021-3afd67a210bf")
...
certificate = createcertificate!(client; name="web-cert-01",
...
@testset "Delete a Certificate" begin
    @test deletecertificate!(client, "892071a0-bb95-49bc-8021-3afd67a210bf")
    @test deletecertificate!(client, certificate)
end;
